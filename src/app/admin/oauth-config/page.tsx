        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {providers.map((provider) => {
              const style = PROVIDER_STYLES[provider.provider] || { icon: '?', bgColor: 'bg-gray-500' };
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-4">
                        {/* Logo */}
                        <div className={`w-12 h-12 rounded-lg ${style.bgColor} flex items-center justify-center text-xl font-bold`}>
                          {style.icon}
                        </div>
